...
// class ProposalApproverHomeScreen extends StatelessWidget {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Approver Home'),
//       ),
//       body: Padding(
...
//                 subtitle: const Text('Review pending and reviewed proposals'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Event Proposals card ───────────────────────────────────
            _NavCard(
              icon: Icons.description_outlined,
              title: 'Event Proposals',
              subtitle: 'Review pending and reviewed proposals',
              onTap: () => context.push('/proposal-approver/proposals'),
            ),

            const SizedBox(height: 12),

            // ── Resource Permissions card ──────────────────────────────
            _NavCard(
