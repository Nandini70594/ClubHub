...
//         future: Future.wait([
//           permissionService.getRequestById(requestId),
//           permissionService.getItemsForRequest(requestId),
//         ]),
...
//           final request = data[0] as PermissionRequestModel?;
//           final items = data[1] as List<PermissionRequestItemModel>;
...
//                         Text(
//                           'Current Approver: ${request.currentApproverRole ?? '-'}',
//                         ),
//                         const SizedBox(height: 10),
//                         Text(
//                           'Requested At: ${_formatDateTime(request.requestedAt)}',
//                         ),
//                         if (request.decidedAt != null) ...[
//                           const SizedBox(height: 10),
//                           Text(
//                             'Decided At: ${_formatDateTime(request.decidedAt)}',
//                           ),
//                         ],
//                         if (request.decisionRemarks != null &&
//                             request.decisionRemarks!.trim().isNotEmpty) ...[
//                           const SizedBox(height: 10),
//                           Text('Remarks: ${request.decisionRemarks}'),
//                         ],
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new, size: 18, color: _kTextDark),
