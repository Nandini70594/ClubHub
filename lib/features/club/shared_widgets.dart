  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: hasFile ? const Color(0xFF3B5BDB).withOpacity(0.3) : Colors.grey.shade100),
      ),
      child: Row(
        children: [
          Container(
              ...
              children: [
                if (label != null)
                  Row(children: [
                    ...
                    if (isRequired) const Text(' *', style: TextStyle(color: Color(0xFFDC2626), fontSize: 13)),
                  ]),
      ...
      child: Row(
        children: [
          ...
          if (isCheckbox)
            ...
            Switch(value: value, onChanged: onChanged, activeColor: const Color(0xFF3B5BDB)),
        ],
      ),
    );
  }
