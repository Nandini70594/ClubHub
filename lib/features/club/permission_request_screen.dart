...
//     final selectedTypes =
//         _resourceTypes.where((type) => _selected[type] == true).toList();
...
//               ? null
//               : _detailControllers[type]!.text.trim(),
//           'remarks': _remarksControllers[type]!.text.trim().isEmpty
//               ? null
//               : _remarksControllers[type]!.text.trim(),
...
//       appBar: AppBar(
//         title: Text(
//           widget.resubmittingRequest == null
//               ? 'Request Permissions'
...
//                             onChanged: (value) {
//                               setState(() {
//                                 _selected[type] = value ?? false;
//                               });
//                             },
//                           ),
//                           if (_selected[type] == true) ...[
//                             const SizedBox(height: 8),
//                             TextField(
//                               controller: _detailControllers[type],
//                               decoration: InputDecoration(
//                                 labelText: type == 'OTHER'
//                                     ? 'Specify resource'
//                                     : 'Resource details',
...
//                             TextField(
//                               controller: _remarksControllers[type],
//                               maxLines: 2,
...
//                                 Expanded(
//                                   child: Text(
//                                     _fileNames[type] ?? 'No document selected',
//                                   ),
//                                 ),
//                                 TextButton(
...
//                   maxLines: 5,
//                   decoration: const InputDecoration(
//                     hintText: 'Enter purpose of resource usage',
//                     border: OutlineInputBorder(),
//                   ),
//                 ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isResubmit ? 'Resubmit Permission Request' : 'Request Permissions',
