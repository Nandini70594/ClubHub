...
//   Widget _buildPermissionStatusChip(String status) {
//     Color color;
//     switch (status) {
//       case 'APPROVED':
//         color = Colors.green;
...
//           final canOpenPermissions =
//               budget != null && budget.status == 'approved';
...
//                   Text('Current Stage: ${event.currentStage}'),
//                   Text('Progress: ${event.progressPct}%'),
//                   const SizedBox(height: 8),
//                   Text('Date: ${event.eventDate}'),
//                   Text('Venue: ${event.venue ?? '-'}'),
//                   const SizedBox(height: 8),
//                   Text('Description: ${event.description ?? '-'}'),
//                   if (event.proposalRemarks != null &&
//                       event.proposalRemarks!.trim().isNotEmpty)
//                     Padding(
//                       padding: const EdgeInsets.only(top: 8),
//                       child: Text('Proposal Remarks: ${event.proposalRemarks}'),
//                     ),
//                   const SizedBox(height: 16),
//                   if (event.proposalStatus == 'pending' ||
//                       event.proposalStatus == 'changes_requested')
//                     SizedBox(
...
//                                 .resubmitProposal(widget.eventId);
//                             await _reload();
//                           },
//                           child: const Text('Resubmit Proposal'),
//                         ),
//                       ),
//                     ),
...
//                     const Text(
//                       'Budget submission will unlock after proposal approval.',
//                     )
//                   else if (budget == null)
//                     SizedBox(
//                       width: double.infinity,
...
//                             '/club/event/${widget.eventId}/budget',
//                           );
...
//                             const SizedBox(height: 8),
//                             Text(
//                               'Note: ${budget.summaryNote?.isNotEmpty == true ? budget.summaryNote : '-'}',
//                             ),
//                             const SizedBox(height: 8),
...
//                                   TextButton(
//                                     onPressed: () =>
//                                         _openBudgetFile(budget.storagePath),
...
//                             ),
//                             if (budget.remarks != null &&
//                                 budget.remarks!.trim().isNotEmpty)
//                               Padding(
//                                 padding: const EdgeInsets.only(top: 8),
//                                 child: Text('Remarks: ${budget.remarks}'),
//                               ),
//                             if (budget.status == 'changes_requested')
//                               Padding(
...
//                                         context,
//                                         MaterialPageRoute(
//                                           builder: (_) => BudgetSubmissionScreen(
...
//                     const Text(
//                       'Permissions will unlock after budget approval.',
//                     )
...
//                                 _buildPermissionStatusChip(
//                                   permissionRequest.status,
//                                 ),
//                               ],
//                             ),
//                             const SizedBox(height: 10),
//                             Text('Purpose: ${permissionRequest.purpose}'),
//                             const SizedBox(height: 8),
//                             Text(
//                               'Current Approver: ${permissionRequest.currentApproverRole ?? '-'}',
//                             ),
//                             if (permissionRequest.decisionRemarks != null &&
//                                 permissionRequest.decisionRemarks!.trim().isNotEmpty)
//                               Padding(
//                                 padding: const EdgeInsets.only(top: 8),
//                                 child: Text(
//                                   'Remarks: ${permissionRequest.decisionRemarks}',
//                                 ),
//                               ),
//                             const SizedBox(height: 12),
//                             SizedBox(
...
//                                 onPressed: () async {
//                                   await context.push(
//                                     '/club/permission-request/${permissionRequest.id}',
//                                   );
//                                 },
//                                 child: const Text('View Permission Request'),
//                               ),
//                             ),
...
//                                       }
//                                     },
//                                     child: const Text('Resubmit Permission Request'),
//                                   ),
//                                 ),
//                               ),
//                           ],
...
//   const Text('Event conduction unlocks after permissions are approved.')
...
//         await _reload();
//       },
//       child: const Text('Mark Event as Conducted'),
//     ),
//   )
// else
//   const Text('Event has been marked as conducted.'),
...
//   const Text('Expense submission unlocks after event is conducted.')
...
//       onPressed: () async {
//         final submitted = await context.push<bool>(
//           '/club/event/${widget.eventId}/expenses',
//         );
...
//         }
//       },
//       child: const Text('Submit Expense Proofs'),
//     ),
//   )
// else
//   const Text('Expense proofs submitted / verified.'),
//   const SizedBox(height: 24),
// const Text(
//   'Closing File',
//   style: TextStyle(
...
//   const Text('Closing file submission unlocks after expense approval.')
...
//       onPressed: () async {
//         final submitted = await context.push<bool>(
//           '/club/event/${widget.eventId}/closing',
//         );
...
//         }
//       },
//       child: const Text('Submit Closing File'),
//     ),
//   )
// else
//   const Text('Event closing file submitted. Event closed.'),
