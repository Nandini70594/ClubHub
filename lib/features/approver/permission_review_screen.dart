...
//           return Scaffold(
//             appBar: AppBar(title: const Text('Permission Review')),
//             body: Center(child: Text('Error: ${snapshot.error}')),
//           );
//         }

//         final items = (snapshot.data?[0] as List?)?.cast<PermissionRequestItemModel>() ?? [];
...
//         return Scaffold(
//           appBar: AppBar(
//             title: const Text('Permission Review'),
//           ),
...
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: [
//                         Text('Purpose: ${widget.request.purpose}'),
//                         const SizedBox(height: 10),
//                         Text(
//                           'Current Approver: ${widget.request.currentApproverRole ?? '-'}',
//                         ),
//                         const SizedBox(height: 10),
//                         Text(
//                           'Requested At: ${_formatDateTime(widget.request.requestedAt)}',
//                         ),
//                         if (widget.request.decisionRemarks != null &&
//                             widget.request.decisionRemarks!.trim().isNotEmpty) ...[
//                           const SizedBox(height: 10),
//                           Text('Remarks: ${widget.request.decisionRemarks}'),
//                         ],
//                       ],
//                     ),
//                   ),
...
//                             Text(
//                               'Resource Details: ${item.resourceDetail?.isNotEmpty == true ? item.resourceDetail : '-'}',
//                             ),
//                             const SizedBox(height: 8),
//                             Text(
//                               'Remarks: ${item.remarks?.isNotEmpty == true ? item.remarks : '-'}',
//                             ),
//                             const SizedBox(height: 8),
...
//                                 children: [
//                                   Expanded(
//                                     child: Text('Document: ${item.documentName}'),
//                                   ),
//                                   TextButton(
//                                     onPressed: () =>
...
//                               )
//                             else
//                               const Text('Document: No file uploaded'),
//                           ],
//                         ),
//                       ),
//                     );
...
//                           onPressed: _isSubmitting ? null : () => _approve(user.role),
//                           child: Text(
//                             _isSubmitting ? 'Please wait...' : 'Approve',
//                           ),
//                         ),
//                       ),
...
//                           onPressed: _isSubmitting ? null : () => _reject(user.role),
//                           child: const Text('Reject'),
//                         ),
//                       ),
//                     ],
...
// Import ERPTheme from the dashboard file, or copy the tokens here:
// (copy ERPTheme class here if files are not co-located)
class ERPTheme {
