...
//           return Scaffold(
//             appBar: AppBar(title: const Text('Permission Approver Dashboard')),
...
//         final pendingFuture =
//             permissionService.getPendingRequestsForRole(user.role);
//         final reviewedFuture =
//             permissionService.getReviewedRequestsForRole(user.role);

//         return DefaultTabController(
//           length: 2,
//           child: Scaffold(
//             appBar: AppBar(
//               title: const Text('Permission Approver Dashboard'),
//               bottom: const TabBar(
//                 tabs: [
//                   Tab(text: 'Pending'),
//                   Tab(text: 'Reviewed'),
...
//                           children: const [
//                             SizedBox(height: 200),
//                             Center(child: Text('No pending permission requests')),
//                           ],
//                         ),
//                       );
//                     }
...
//                                   MaterialPageRoute(
//                                     builder: (_) =>
//                                         PermissionReviewScreen(request: request),
//                                   ),
//                                 );
...
//                           children: const [
//                             SizedBox(height: 200),
//                             Center(child: Text('No reviewed permission requests')),
//                           ],
//                         ),
//                       );
//                     }
...
//                               title: Text(request.purpose),
//                               subtitle: Text(
//                                 '${request.status} • ${request.decisionRemarks ?? '-'}',
//                               ),
//                               trailing: Text(
...
// ── Design tokens (shared across all ERP screens) ──────────────────────────
class ERPTheme {
